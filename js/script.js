...
// Question 1
document.querySelector("#host-name").inner
...
//Question 6
let radioResetButton = document.querySelector("#radio-reset-button");
...
colorPicker.addEventListener("input", function (event) {
  ...
  if (backgroundColor === textColor) {
    document.body.style.color = backgroundColor === "#000000" ? "#FFFFFF" : "#000000";
  }
});
